		...
		return new Promise(resolve => {
			async function doGet(resolve) {
				$.post("https://api.ropro.io/getSubscription.php?key=" + await getStorage("subscriptionKey"), function(data){
					setStorage("rpSubscription", crackedsub)
					resolve(crackedsub);
				}).fail(async function() {
...
connectedNotification({subject:"Cracked by Ziggy",message:"Enjoy!\n\nRemember to join our forum. notziggy.xyz/forum"})