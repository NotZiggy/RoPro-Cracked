...
profileThemeBoxHTML = `<div class="section-content"><button id="saveTheme" type="button" class="btn-fixed-width-lg btn-growth-lg" style="background-color:#0084dd;border:0px;font-size:18px;padding:5px;float:right;">${chrome.i18n.getMessage("RemoveTheme")}</button><p id="themeResponseText"></p><div style="width:100%;float:left;margin-top:10px;"><h3 style="margin-bottom:-10px;">${chrome.i18n.getMessage("RoProProfileThemes")}</h3><h7 style="font-size:14px;margin-top:-10px;">${chrome.i18n.getMessage("OtherRoproUsersWillSeeYourThemeWhenTheyVisitYourProfile")}</h7><br><br></div><div style="min-height:150px" id="profileThemeCardBox"></div><br><div style="width:100%;float:left;margin-top:10px;"><h3 style="margin-bottom:-10px;">${chrome.i18n.getMessage("AnimatedThemes")}</h3><h7 style="font-size:14px;margin-top:-10px;">${chrome.i18n.getMessage("AnimatedThemesAreAvailableForSubscribersOnly")}</h7><br><br><div style="min-height:110px;" id="animatedThemeCardBox"></div></div><div style="width:100%;float:left;margin-top:10px;"><h3 style="margin-bottom:-10px;">${chrome.i18n.getMessage("CustomThemes")}</h3><h7 style="font-size:14px;margin-top:-10px;">${chrome.i18n.getMessage("ToSubmitACustomThemeForApprovalJoinTheRoProDiscordServer")} <a href="https://ropro.io/discord" target="_blank">https://ropro.io/discord</a> </h7><a href="https://ropro.io/discord" target="_blank"><img src="https://ropro.io/images/discordicon.png" style="width:30px;"></a><br><div style="min-height:150px;" id="customThemeCardBox"></div></div></div>`
